    ...
    public static class MD5 {
        ...
        public static String encrypt(InputStream contentStream) {
            try {
                ...
                throw new IllegalArgumentException("MD5 encrypt failed!", e);
            }
//            return null;
        }
    }
    ...
    public static class AES {
        ...
        public static String generaterKey() {
            ...
            try {
                ...
                throw new IllegalArgumentException("AES generater Key failed!", e);
            }
            // 16 字节 == 128 bit
        ...
        public static String encrypt(String content, String secretKey) {
            ...
            try {
                ...
                throw new IllegalArgumentException("AES encrypt failed!", e);
            }
//            return null;
        }
        ...
        public static String decrypt(String content, String secretKey) {
            ...
            try {
                ...
                throw new IllegalArgumentException("AES decrypt failed!", e);
            }
//            return null;
        }
    }
    ...
    public static class RSA {
        ...
        public static Pair<String, String> generateKeyPair() {
            ...
            try {
                ...
                //hrow new EncryptionException("RSA generate Key Pair failed!", e);
            }
        ...
        public static Pair<String, String> generateKeyPair(int keySize) {
            ...
            try {
                ...
                throw new IllegalArgumentException("RSA generate Key Pair failed!", e);
            }
        ...
        public static RSAPublicKey getPublicKey(String publicKey) {
            try {
                ...
                throw new IllegalArgumentException("RSA get Public Key failed!", e);
            }
//            return null;
        }
        ...
        public static RSAPrivateKey getPrivateKey(String privateKey) {
            try {
                ...
                throw new IllegalArgumentException("RSA get Private Key failed!", e);
            }
//            return null;
        }
        ...
        public static String sign(String content, String privateKey) {
            try {
                ...
                throw new IllegalArgumentException("RSA sign failed!", e);
            }
//            return null;
        }
        ...
        public static boolean verify(String content, String sign, String publicKey) {
            try {
                ...
                throw new IllegalArgumentException("RSA verify failed!", e);
            }
//            return false;
        }
        ...
        public static String encrypt(String content, Key key) {
            try {
                ...
                throw new IllegalArgumentException("RSA encrypt failed!", e);
            }
//            return null;
        }
    ...
    public static class RSA2 {
        ...
        public static String sign(String content, String privateKey) {
            try {
                ...
                throw new IllegalArgumentException("RSA2 sign failed!", e);
            }
//            return null;
        }
        ...
        public static boolean verify(String content, String sign, String publicKey) {
            try {
                ...
                throw new IllegalArgumentException("RSA2 verify failed!", e);
            }
//            return  false;
        }
